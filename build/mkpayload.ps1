<#
  ...
  Phase 7 step 1: nothing here comes from a local DSH installation any more. Every
...
# user-level skill (A1/A2 in docs\dev\DECISION-agents-scope-and-slot-handoff.md). dsh scans
...
# The two ledgers the skill requires (D1): seeds, still carrying the placeholder the installer
