...
func TestCommandLineUsesSlotPathsAndPort(t *testing.T) {
	...
	// the port probe says the instance is actually answering (PLAN section 6 item 1).
...
// TestLaunchPathsAbsoluteAreUsedAsWritten (O2): an absolute launch.node_exe /
...
// TestLaunchPathsRelativeStayRelativeToTheSlotRoot (O2): the documented default is
